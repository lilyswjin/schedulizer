        ...
        <div className="App">
          ...
          <main className="main">
            ...
            <Switch>
              ...
              <Route path="/projects" exact render={(routeProps) => <Project {...routeProps} projectList={this.state.projectList} clientList={this.state.clientList} assignedEmployees={this.state.assignedEmployees} fetchProjects={this.fetchProjects} /> } />
